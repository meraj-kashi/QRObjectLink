...
resource "aws_cloudwatch_log_group" "cv_digitalisering_presigned_url_cw_log_group" {
...
resource "aws_cloudwatch_log_group" "cv_digitalisering_qr_code_cw_log_group" {
